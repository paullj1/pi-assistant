...
ASSISTANT_STT_STREAM_KEEPALIVE_SECONDS = 0.5
...
ASSISTANT_WAKE_MODEL = "hey_jarvis"
ASSISTANT_WAKE_MODEL_DIR = "~/.config/pi-assistant/openwakeword"
ASSISTANT_WAKE_THRESHOLD = 0.5
ASSISTANT_WAKE_COOLDOWN_SECONDS = 1.0
ASSISTANT_WAKE_PRE_ROLL_SECONDS = 1.5
ASSISTANT_WAKE_RMS_FLOOR = 0.001
ASSISTANT_WAKE_RMS_WINDOW_SECONDS = 1.0
ASSISTANT_WAKE_DEVICE = "cpu"
ASSISTANT_WAKE_ONE_SHOT_GRACE_SECONDS = 0.8
ASSISTANT_FOLLOWUP_WAIT_SECONDS = 2.5
ASSISTANT_FOLLOWUP_NO_RESPONSE_TTS = "Alright, just let me know if you need anything."
