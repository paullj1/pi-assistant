...
WAKE_MODEL = _as_str("ASSISTANT_WAKE_MODEL", "hey_jarvis").strip()
WAKE_MODEL_DIR = _as_str(
    "ASSISTANT_WAKE_MODEL_DIR", os.path.join(XDG_CONFIG_HOME, "pi-assistant", "openwakeword")
).strip()
WAKE_THRESHOLD = _as_float("ASSISTANT_WAKE_THRESHOLD", 0.5)
WAKE_COOLDOWN_SECONDS = _as_float("ASSISTANT_WAKE_COOLDOWN_SECONDS", 1.0)
WAKE_PRE_ROLL_SECONDS = _as_float("ASSISTANT_WAKE_PRE_ROLL_SECONDS", 1.5)
WAKE_RMS_FLOOR = _as_float("ASSISTANT_WAKE_RMS_FLOOR", 0.001)
